...
def predict_disease(model, image_path):
    ...
    labels = label=["Apple___Apple_scab suggest Pest-Captan,Chlorothalonil,Copper (Organic","Apple___Black_rot suggest to Pest-Avoid replanting into the same area that contained a previously infected plant.","Apple___Cedar_apple_rust suggest to Pest-Organicdews Neemoil,cinnaprot-proteco,Superkukulus-100ml","Apple___Healthy",
